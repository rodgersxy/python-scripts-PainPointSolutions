...
# Common email providers in Kenya and some fictional company domains
email_domains = [
    "gmail.com", "yahoo.com", "hotmail.com", "outlook.com",
    "safaricom.co.ke", "ke.nationmedia.com", "standardmedia.co.ke",
    "africaonline.co.ke", "wananchi.com", "jambo.co.ke",
    "nbo.ke", "uonbi.ac.ke", "strathmore.edu", "kenyaweb.com"
]
...
def generate_random_email(is_phishing):
    sender = generate_random_email_address()
...
# Save to Excel file
excel_file = "kenyan_banking_emails_final.xlsx"
